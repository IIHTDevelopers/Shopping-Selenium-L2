...
import pages.Practice_Automation_Pages;
import pages.StartupPage;
import testBase.AppTestBase;
import testdata.LocatorsFactory;

public class Practice_Automation_TestCases extends AppTestBase
{
	Map<String, String> configData;
	Map<String, String> loginCredentials;
	String expectedDataFilePath = testDataFilePath+"expected_data.json";
	StartupPage startupPage;
	Practice_Automation_Pages practiceAutomationInstance;
	...
	public void initBrowser(String browser, String environment) throws Exception {
		...
		public void verifyNavigateTotTheShoppingCartpage() throws Exception {
			practiceAutomationInstance= new Practice_Automation_Pages(driver);
